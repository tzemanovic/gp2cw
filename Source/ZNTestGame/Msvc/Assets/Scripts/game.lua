...
function initGame()
	...
	armoredReconTrans:SetPosition(fVec3(0.0,2.5,10.0))
	armoredReconTrans:SetScale(fVec3(1.0,1.0,1.0))
	armoredReconTrans:SetRotation(fVec3(0.0,180.0,20.0))
	...
	--armoredReconMesh:CreateCubeGeometry(fVec3(1.0, 0.6, 2.8))
	...
	armoredReconBoxCollider=BoxColliderComponent(fVec3(1.0, 0.6, 2.8))
